  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center px-6">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#1a1a33] via-[#0f0f2a] to-[#1c1c1c]"></div>
...
<div className="mt-10 w-full">
  ...
  <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-[#1c1c1c]/90 shadow-2xl backdrop-blur-md transition-all duration-300 hover:border-white/15">
  {/* Textarea area */}
  <div className="px-5 pb-2 pt-5">
    <p className="text-left text-lg text-white/40">
  ...
  <div className="flex items-center justify-between px-5 pb-4 pt-6">
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex size-8 items-center justify-center rounded-full bg-white/10 text-white/50">
        <ArrowUp className="size-4" /> {/* import ArrowUp */}
      </div>
    </div>
  </div>
</div>
