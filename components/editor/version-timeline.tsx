...
import { Bot, FileCode, GitCompare, Pencil, RotateCcw } from "lucide-react";
...
function getVersionTypeBadge(type: VersionMeta["type"]) {
  switch (type) {
    case "ai":
      return { label: "AI Gen", icon: Bot, variant: "default" as const };
    case "manual":
...
>
  <DialogContent showCloseButton={false}>
    <DialogHeader>
      ...
      <DialogDescription>
        This will create a new version with the files from v
        {restoreConfirmVersion}. Your current version and history will not
        be lost.
      </DialogDescription>
    </DialogHeader>
    <DialogFooter>
